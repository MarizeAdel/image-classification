...
path=os.path.join(r"C:\Users\Mina Gamal\Desktop\Dataset\Training")
...
lbls = one_hot.fit_transform(lbls)
...
#add model layers
model.add(Conv2D(32,(3,3),input_shape=(32,32,3), strides=(1, 1),
                 activation='relu'))
...
model.compile(optimizer=tf.keras.optimizers.Adamax(learning_rate=0.006),loss="sparse_categorical_crossentropy", metrics=['accuracy'])
